...
public class CheckBoxesDemo extends CommonMethods {
	...
	public static final String SYNTAX_PARACTICE_URL = "http://166.62.36.207/syntaxpractice/index.html";;

	public static void main(String[] args) throws InterruptedException {
		CommonMethods.setUp("chrome", SYNTAX_PARACTICE_URL);
		...
		WebElement ageCheckBox = driver.findElement(By.id("isAgeSelected"));// store it in a variable type WebElement
