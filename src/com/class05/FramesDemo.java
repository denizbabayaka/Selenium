...
public class FramesDemo extends CommonMethods {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * 2. do some action in the main window. I'm getting some text from main window
		 * 
		...
		Thread.sleep(2000);
		//Switch to Frame from main window  so you can perform action inside the frame
		...
		//This method will take the focus of your webdriver back to the main window
		driver.switchTo().defaultContent();
		
		//driver.switchTo().parentFrame() switch to parent from parent
